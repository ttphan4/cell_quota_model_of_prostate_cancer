function dxdt = new_model_fixed_mu(t,x) 
% all new model files are the same
% This function takes input parameter through global commands.
global params
% collect parameter values to pass to ODE function
% global bmin;
p = params;
mu = p(1);  q2= p(2); d1 = p(3); gamma1 = p(4); A0 = p(5); 
% fixed parameters
dd1 = 5; dd2 = 5;
q1= 0.5;
b = 0.05; R1 = 3; 
